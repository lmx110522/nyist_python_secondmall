    ...
    $(".my_table").delegate('.old_password','blur',function () {
        ...
        if(password.trim().length != 0){
            ...
            if(result.flag == true){
                ...
                $(".password").after('<tr class="new_password"><td><span class="msg_left">新密码</span></td><td><input type="text" placeholder="输入新密码" name="password" id="passoword" class="form-control add_password new_password1 can_change"><p  class="password_error1" style="margin-top:10px;\n' +
                '    color:firebrick;"></p></td></tr>' +
                '<tr><td><span class="msg_left">确认密码</span></td><td><input type="text" placeholder="确认密码"  class="form-control can_change repassword add_password"></td>')
                $("#passoword").focus()
            }
            else{
